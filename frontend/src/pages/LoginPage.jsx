      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white">
        <div className="w-full max-w-md">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="••••••••••"
                  className="w-full pr-10 px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-brand-gold focus:border-transparent text-sm transition-all"
          ...
          <p className="mt-4 text-center text-sm text-gray-500">
            Forgot password?{' '}
            <Link to="/forgot-password" className="text-brand-gold font-semibold hover:underline">
              Reset password
            </Link>
          </p>
